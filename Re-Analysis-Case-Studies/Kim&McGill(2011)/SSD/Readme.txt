Subdirectories Model 1 and Model contain Mplus input files, SSD and output files
Subdirectory R contains R-files and SSD to estimate the mediation models, and output files
