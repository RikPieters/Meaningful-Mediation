...
sink(paste(getwd(),"/Kupor&Tormala(2015)_SSD_Model_1_3_power.txt",sep = ""))
...
sink()
paste("The output has been saved at: ", getwd(),"/Kupor&Tormala(2015)_SSD_Model_1_3_power.txt",sep = "")
